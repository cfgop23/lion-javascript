...
friends.length = 3; // 길이를 직접 변경할 수 있다. 대신 배열의 길이보다 작게 설정하면 뒷부분이 삭제됨

// 배열 요소 변경
friends[0] = '선범';

// 배열 요소 추가
let unshift = friends.unshift('진승'); // 앞 추가
let push = friends.push('동균'); // 뒤 추가
