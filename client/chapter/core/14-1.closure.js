...
// first()(); // currying function(이렇게는 잘 안씀)
...
let result = counter(); // result는 가비지 컬렉터가 수집 대상으로 보지 않는다
// 클로저는 increase 함수만 기억하는게 아니라 counter()의 환경 자체를 기억한다
